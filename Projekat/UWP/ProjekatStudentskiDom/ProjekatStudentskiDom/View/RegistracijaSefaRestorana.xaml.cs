...
namespace ProjekatStudentskiDom
{
    ...
    /// </summary>
    public sealed partial class RegistracijaSefaRestorana : Page
    {
        StudentskiDom sd;
        public RegistracijaSefaRestorana(StudentskiDom sd)
        {
        ...
        IMobileServiceTable<SefRestorana> sefTableObj = App.mobileService.GetTable<SefRestorana>();
