...
namespace StudentskiDomASPNET.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AdminId,Ime,Prezime,DatumRodjenja,Username,Password,Jmbg")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AdminId,Ime,Prezime,DatumRodjenja,Username,Password,Jmbg")] Admin admin)
        {
            if (ModelState.IsValid)
            {
